                                ...
                                !firstQuestion ? (
                                        ...
                                        <div className={`${ !props.isMobile ? style.chooseCountry : `row ${style.chooseCountryM}`} mt-5 mb-5`}>
                                            <label>
                                                ...
                                                <select value={firstCountry}
                                                        onChange={() => setFirstCountry(event.target.value)} required>
                                            ...
                                            <label>
                                                ...
                                                <select value={secondCountry}
                                                        onChange={() => setSecondCountry(event.target.value)} required>
                                            ...
                                            <label>
                                                ...
                                                <select value={thirdCountry}
                                                        onChange={() => setThirdCountry(event.target.value)} required>
                                    ...
                                    <React.Fragment>
                                        ...
                                        <div className={`${!props.isMobile ? style.language : style.languageM}`}>
                                            <label>
                                                زبان اول:
                                                <select onChange={()=>setFirstLanLevel(event.target.value)}>
