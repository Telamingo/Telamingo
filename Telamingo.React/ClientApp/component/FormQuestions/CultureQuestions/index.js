                                ...
                                !firstQuestion ? (
                                    <React.Fragment>
                                        ...
                                        <div className={`${style.creedRate} mt-5 mb-5`}>
                                            <span>0</span>
                                            <input type="range" min="0" max="10" onChange={()=>setFirstQuestionRate(event.target.value)}/>
                                    ...
                                    <React.Fragment>
                                        ...
                                        <div className={`${style.creedRate} mt-5 mb-5`}>
                                            <span>0</span>
                                            <input type="range" name="vol" min="0" max="10" onChange={()=>setSecondQuestionRate(event.target.value)}/>
                                    ...
                                    <React.Fragment>
                                        ...
                                        <div className={`${style.creedRate} mt-5 mb-5`}>
                                            <span>0</span>
                                            <input type="range" name="vol" min="0" max="10" onChange={()=>setThirdQuestionRate(event.target.value)}/>
                                    ...
                                    <React.Fragment>
                                        ...
                                        <div className={`${style.creedRate} mt-5 mb-5`}>
                                            <span>0</span>
                                            <input type="range" name="vol" min="0" max="10" onChange={()=>setForthQuestionRate(event.target.value)}/>
