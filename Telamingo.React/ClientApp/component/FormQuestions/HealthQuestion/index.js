                                            ...
                                            !haveASick ? (
                                                ...
                                                <React.Fragment>
                                                    <div className={`${style.chooseSick} mt-5 mb-5`}>
                                                        بیماری شما:
                                                        <select value={sick}
                                                                onChange={() => setSick(event.target.value)} required>
                                    ...
                                    <React.Fragment>
                                        ...
                                        <div className={`mt-3 ${style.mealHoby}`}>
                                            ...
                                            <input type="number" min="1" max="10" step="1"
                                                   onChange={() => setFirstMealRate(event.target.value)}/>
                                        </div>
                                        <div className={`mt-3 ${style.mealHoby}`}>
                                            <label>غذاهای فست فودی (1 تا 10)</label>
                                            <input type="number" min="1" max="10" step="1"
                                                   onChange={() => setSecondMealRate(event.target.value)}/>
                                        </div>
                                        <div className={`mt-3 ${style.mealHoby}`}>
                                            <label>گیاهخواری (1 تا 10)</label>
                                            <input type="number" min="1" max="10" step="1"
                                                   onChange={() => setThirdMealRate(event.target.value)}/>
                                        </div>
                                        <div className={`mt-3 ${style.mealHoby}`}>
                                            <label>غذای سنتی ملل (1 تا 10)</label>
                                            <input type="number" min="1" max="10" step="1"
                                                   onChange={() => setForthMealRate(event.target.value)}/>
                                        </div>
                                        <div className={`mt-3 ${style.mealHoby}`}>
                                            ...
                                            <input type="number" min="1" max="10" step="1"
                                                   onChange={() => setFifthMealRate(event.target.value)}/>
                                        </div>
                                        {
                                            firstMealRate == "" ?
                                                <div className={`${!props.isMobile ? "" : style.mobileButton}`}>
